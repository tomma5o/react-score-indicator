...
export default function SvgComp(props) {
  ...
  return (
    <Svg
      ...
      viewBox="0 0 474 387.26"
    >
      <path
        className={`step_1 ${step_1}`}
        fill="#FF2D2D"
        d="M67.16,397.93A236,236,0,0,1,16,285.4l28.07-4.52a207.5,207.5,0,0,0,45,98.94Z"
        transform="translate(-13 -10.67)"
      />
      <path
        className={`step_2 ${step_2}`}
        fill="#FF9B55"
